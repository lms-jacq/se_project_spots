...
const avatarAddlButton = document.querySelector(".profile__avatar-button");
...
const deleteCloseButton = document.querySelector(".modal__close-button-delete");
...
avatarAddlButton.addEventListener("click", () => {
